				...
				<slot name="body">
					<view class="uni-list-item__content"
						...
						<text v-if="title" class="uni-list-item__content-title"
							...
							:style="{fontSize:titleSize + 'rpx'}">{{ title }}</text>
...
<style lang="scss">
	// 自定义内容
	$leafAngle-font-size-sm:24rpx;
	$leafAngle-font-size-base:36rpx;
	$leafAngle-font-size-lg:48rpx;
	...
	.uni-list-item__content-title {
		font-size: $leafAngle-font-size-base;
		color: #3b4144;
		overflow: hidden;
	}
